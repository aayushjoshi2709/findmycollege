...
export class CollegeController{
    ...
    @UseGuards(AuthGaurd)
    @Post()
    async addNewCollege(@Body() body :CreateCollegeDto){
        let college = await this.collegeService.addCollege(body.name, body.website, body.userid, body.courses, body.address, body.phoneNo, body.about, body.location);
        return college;
    }
